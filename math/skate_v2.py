...
flat_deck = {
    ...
    "Variable flip": {"count": 1, "difficulty": 3, "type" : "trick",
        "description":"A kickflip with a backside pop shove-it."},
    "Variable heelflip": {"count": 1, "difficulty": 3, "type" : "trick",
        "description":"A heelflip combined with a frontside pop shuvit"},

    "Heelflip": {"count": 1, "difficulty": 3, "type" : "trick",
    ...
    "Dolphin Flip": {"count": 1, "difficulty": 5, "type" : "trick",
    ...
    "Impossible": {"count": 1, "difficulty": 5, "type" : "trick",
...
grind_deck = {
    ...
    "Lipslide": {"count": 2, "difficulty": 3, "type" : "trick",
    ...
    "Tailslide": {"count": 2, "difficulty": 3, "type" : "trick",
    ...
    "Noseslide": {"count": 2, "difficulty": 3, "type" : "trick",
    ...
    "Bluntslide": {"count": 1, "difficulty": 4, "type" : "trick",
        "description":"A skateboarding trick where the rider slides along the edge of a rail or ledge with the tail of the skateboard."},
    "Nose Bluntslide": {"count": 1, "difficulty": 4, "type" : "trick",
        "description":"A skateboarding trick where the rider slides along the edge of a rail or ledge with the nose of the skateboard."},

    "Smith Grind": {"count": 1, "difficulty": 5, "type" : "trick",
    ...
    "Feeble Grind": {"count": 1, "difficulty": 5, "type" : "trick",
    ...
    "Crooked Grind": {"count": 1, "difficulty": 5, "type" : "trick",
    ...
    "Salad Grind": {"count": 1, "difficulty": 5, "type" : "trick",
...
while (lines_left>0):
    ...
    drawn_cards = []
    drawn_cards.extend(draw_cards(master_deck, tricks_per_line))
    ...
    print("Trick Lines Left: {}".format(lines_left))

    reshuffle = yes_no_input("Re-Draw? ")
    if reshuffle:
        # Put cards back into deck if re-drawing
